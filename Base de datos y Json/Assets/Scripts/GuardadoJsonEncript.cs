...
public class GuardadoJsonEncript : MonoBehaviour
{
    ...
    public class SaveData
    {
        ...
        public SaveData( string _name,int _dinero)
        {
    ...
    public void guardar()
    {
        ...
        SaveData sd = new SaveData(name, dinero);
        ...
        string saveFilePath = Application.persistentDataPath + "/infoJson.sav";
